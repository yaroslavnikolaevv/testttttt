...
def send_text(message):
	...
	global drugoy2
	global kusokgovna
	if s == 1 and message.text.lover() == "другой":
		bot.send_message(message.chat.id, 'Введите свой город?')
		s = 11
	elif s == 11:
		otkuda = message.text
		bot.send_message(message.chat.id, 'Вы едете на отдых или по работе?', reply_markup=keyboard2)			
	elif s == 3 and message.text.lover() == "другой":
		s =  31
	elif s == 31:
		kuda = message.text
		s = 2
		...
		s = 2
		bot.send_message(message.chat.id, 'Вы едете на отдых или по работе?', reply_markup=keyboard2)
	elif s == 2 and message.text.lover() == "рабочая поездка":
		bot.send_message(message.chat.id, 'Вы едете на отдых или по работе?', reply_markup=keyboard4)
		s = 3
	elif s == 2 and message.text.lover() == "туризм":
		bot.send_message(message.chat.id, 'Вы едете на отдых или по работе?', reply_markup=keyboard3)
		s = 3
	elif s == 3:
		kuda = message.text
		s = 4
		...
		bot.send_message(message.chat.id, message.text,reply_markup=keyboardOk)
		s = 6
	elif s == 6 and message.text.lover() == "поиск":
